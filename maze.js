...
function myFunction() {  
  ...
  let newMaze = new Maze(500, x.value, x.value);
  var defaultVal = x.defaultValue;
  var currentVal = x.value;
  if (currentVal <= 30) {
    document.getElementById("demo").innerHTML = "<span style='color: #28df99'>very Good you are the best 👍 "
    
  } else {
    document.getElementById("demo").innerHTML = "<span style='color: #fa163f'>Why you are doing this😹"
  }
  newMaze.setup();
  newMaze.draw();
